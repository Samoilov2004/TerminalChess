...
*(Совет: сделайте скриншот вашей игры, загрузите его на сервис вроде [Imgur](https://imgur.com/upload) и вставьте сюда ссылку, чтобы README был еще нагляднее)*
...
*   **Гибкий интерфейс:**
    *   Мультиязычная поддержка (Русский 🇷🇺 / English 🇬🇧).
